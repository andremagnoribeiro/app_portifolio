    ...
    <AppBar position="relative" style={{ width: "100%" }} >
      <Toolbar>
        ...
        <img  alt="logo ufjf" style={{height:40, margin:10}} src="https://doity.com.br/media/doity/eventos/evento-19789-logo_organizador.png" />
          ...
          <Typography onClick={handleClickPortifolio_Lattes} >
            Portfolio
          </Typography>
          ...
          >
            ...
            <MenuItem onClick={handleClosePortifolio_Lattes}><Link component={Typography} to={`/`}>SIGA</Link></MenuItem>
            <MenuItem onClick={handleClosePortifolio_Lattes}><Link component={Typography} to={`/`}>Lattes</Link></MenuItem>
          </Menu>
        </IconButton>
...
import suseStyles from './suseStyles.js';
