      ...
      {(
        ...
        <Card style={{ marginTop: 30, paddingBottom: 30, backgroundColor: "#d3d3d3" }}>
          ...
          {(item.nome_grande_area_do_conhecimento_1 && item.nome_grande_area_do_conhecimento_1 !== 'NULL') && <Card style={{ margin: 20, paddingBottom: 30, backgroundColor: "#d3d3d3" }}>
            ...
            <ItemCard title={"Área do Conhecimento:"} valor={item.nome_da_area_do_conhecimento_1} />
            <ItemCard title={"Especialidade:"} valor={item.nome_da_especialidade_1} />
            <ItemCard title={"Sub Área do conhecimento:"} valor={item.nome_da_sub_area_do_conhecimento_1} />
          ...
          {(item.nome_grande_area_do_conhecimento_2 && item.nome_grande_area_do_conhecimento_2 !== 'NULL') && <Card style={{ margin: 20, paddingBottom: 30, backgroundColor: "#d3d3d3" }}>
            ...
            <ItemCard title={"Área do Conhecimento:"} valor={item.nome_da_area_do_conhecimento_2} />
            <ItemCard title={"Especialidade:"} valor={item.nome_da_especialidade_2} />
            <ItemCard title={"Sub Área do conhecimento:"} valor={item.nome_da_sub_area_do_conhecimento_2} />
          ...
          {(item.nome_grande_area_do_conhecimento_3 && item.nome_grande_area_do_conhecimento_3 !== 'NULL') && <Card style={{ margin: 20, paddingBottom: 30, backgroundColor: "#d3d3d3" }}>
            ...
            <ItemCard title={"Área do Conhecimento:"} valor={item.nome_da_area_do_conhecimento_3} />
            <ItemCard title={"Especialidade:"} valor={item.nome_da_especialidade_3} />
            <ItemCard title={"Sub Área do conhecimento:"} valor={item.nome_da_sub_area_do_conhecimento_3} />
